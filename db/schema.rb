...
ActiveRecord::Schema[8.1].define(version: 2026_07_22_164407) do
  ...
  create_table "soul_link_emulator_save_slots", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.bigint "soul_link_emulator_session_id", null: false
    t.datetime "updated_at", null: false
    t.index ["soul_link_emulator_session_id", "slot_number"], name: "idx_soul_link_emulator_save_slots_session_slot", unique: true
    t.index ["soul_link_emulator_session_id"], name: "idx_on_soul_link_emulator_session_id_e3c171974a"
  end

  create_table "soul_link_emulator_sessions", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "active_save_slot"
    t.datetime "created_at", null: false
  ...
  create_table "soul_link_pokemon_groups", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.bigint "discord_death_message_id"
    t.text "eulogy"
    t.string "location", null: false
